...
class VapiException implements Exception {
  ...
  @override
  String toString() =>
      'VapiException: $message${details != null ? '\nDetails: $details' : ''}';
}
...
class VapiMissingAssistantException extends VapiException {
  const VapiMissingAssistantException()
      : super('Either assistantId or assistant must be provided');
}
...
class VapiStartCallException extends VapiException {
  const VapiStartCallException([dynamic details])
      : super('Failed to start call', details);
}
